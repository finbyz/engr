...
frappe.query_reports["Stock Balance Innovative"] = {
	onload: function() {
...
finbyzerp.view_stock_ledger_report = {
    view_stock_ledger_report: function(item_code,company, from_date, to_date, warehouse){
